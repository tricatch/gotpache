...
Development utility - act as apache proxypass and generates its own certificates for sites.
...
- https://foo.com/test1 -----> gotpache ----> 127.0.0.1:8080
- https://foo.com/test2 -----> gotpache ----> 127.0.0.1:9090
